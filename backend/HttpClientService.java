...
// Usage Example / Integration Class
class PostmanBackendService {
    ...
    // Method to be called from your Swing frontend
    public HttpResponse handleRequest(String url, String method, Map<String, String> headers, String body) {
        try {
            ...
            return httpClientService.executeRequest(requestData);
        } catch (Exception e) {
            HttpResponse errorResponse = new HttpResponse();
            errorResponse.setError(true);
    ...
    public static void main(String[] args) {
        ...
        // Example POST request that will now require an explicit Content-Type
        Map<String, String> headers = new HashMap<>();
        headers.put("Content-Type", "application/json; charset=UTF-8");
        
        HttpResponse response = service.get("https://www.google.com", headers);
